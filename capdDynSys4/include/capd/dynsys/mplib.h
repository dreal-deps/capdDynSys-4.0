...
namespace capd{
  ...
  typedef capd::dynsys::SolverHOE<capd::MpIMap, capd::dynsys::DLastTermsStepControl > MpIOdeSolver;
...
///@deprecated
  ...
  typedef capd::dynsys::SolverHOE<capd::MpIMap, capd::dynsys::DLastTermsStepControl > MpITaylor;
