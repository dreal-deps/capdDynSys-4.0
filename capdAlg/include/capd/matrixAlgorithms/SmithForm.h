...
namespace capd
{
  ...
  namespace matrixAlgorithms
  {
    ...
    struct SmithFormTraitsBasic
    {
      ...
      static const size_type ROWS = MatrixT::ROWS;
      static const size_type COLS = MatrixT::COLS;
    ...
    struct SmithFormTraits : SmithFormTraitsBasic<MatrixT, void*, void*>
    {
      ...
      using typename Basic::Matrix;
      using typename Basic::ScalarType;
      using Basic::ROWS;
      using Basic::COLS;
      typedef capd::vectalg::Matrix<ScalarType, ROWS, ROWS> SqMatrix1;
      typedef capd::vectalg::Matrix<ScalarType, COLS, COLS> SqMatrix2;
    };
